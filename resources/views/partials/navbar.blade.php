...
<body>
    <div class="grid grid-cols-12 lg:py-2 py-0 px-4 items-center fixed bg-white top-0 w-full">
        <img src="{{ asset('storage/gambar/logoaksa.png') }}" alt="" class="lg:col-span-2 col-span-6 md:col-span-5 lg:w-2/3 w-1/2">
        ...
        <button id="dropdownButton" class="p-4 lg:hidden text-black ml-auto relative col-span-6" class="dropbtn">
