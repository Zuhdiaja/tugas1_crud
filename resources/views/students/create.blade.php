...
<div class="lg:w-1/3 md:w-2/4 w-2/3 mx-auto bg-white shadow-lg p-5 mt-16">
  <form action="{{ url('students') }}" method="POST" enctype="multipart/form-data" class="w-full mt-8">
    ...
    <input type="text" name="name" id="name" class="border-none text-sm w-full py-1 px-0" placeholder="Nama" required>
    <hr class="mb-5">
    <h2 class="font-semibold text-slate-700">Nis</h2>
    <input type="number" name="nis" id="nis" class="border-none text-sm w-full py-1 px-0" placeholder="Nis" required>
    <hr class=" mb-5">
    ...
    <input type="file" name="photo" id="photo" class="p-0 w-full" required>
